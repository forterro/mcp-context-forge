...
class TeamManagementService:
    ...
    async def create_team(
        ...
        oidc_group_ids: Optional[list] = None,
        oidc_sync_role: str = "member",
    ) -> EmailTeam:
        """Create a new team.
        ...
        Args:
            ...
            oidc_sync_enabled: Enable automatic membership sync from OIDC groups
            oidc_group_ids: List of OIDC group identifiers mapped to this team
            oidc_sync_role: Role assigned to members synced from OIDC groups
        ...
        try:
            ...
            if existing_inactive_team:
                ...
                existing_inactive_team.oidc_group_ids = oidc_group_ids
                ...
                team = EmailTeam(name=name, description=description, created_by=created_by, is_personal=False, visibility=visibility, max_members=max_members, oidc_sync_enabled=oidc_sync_enabled, oidc_group_ids=oidc_group_ids, oidc_sync_role=oidc_sync_role, is_active=True)
                self.db.add(team)
    ...
    async def update_team(
        ...
        skip_limits: bool = False,
        oidc_sync_enabled: Optional[bool] = None,
        oidc_group_ids: Optional[list] = None,
        oidc_sync_role: Optional[str] = None,
    ) -> bool:
        ...
        try:
            ...
            if oidc_group_ids is not None:
                team.oidc_group_ids = oidc_group_ids
            if oidc_sync_role is not None:
                if oidc_sync_role in ("owner", "developer", "member"):
