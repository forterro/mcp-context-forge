...
class TeamManagementService:
    ...
    async def create_team(
        ...
        oidc_group_id: Optional[str] = None,
        ...
        try:
            ...
            if existing_inactive_team:
                ...
                existing_inactive_team.oidc_group_id = oidc_group_id
                ...
                team = EmailTeam(name=name, description=description, created_by=created_by, is_personal=False, visibility=visibility, max_members=max_members, oidc_sync_enabled=oidc_sync_enabled, oidc_group_id=oidc_group_id, oidc_sync_role=oidc_sync_role, is_active=True)
                self.db.add(team)
    ...
    async def update_team(
        ...
        try:
            ...
            if oidc_group_id is not None:
                team.oidc_group_id = oidc_group_id
